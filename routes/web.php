...
Route::group([
    ...
    Route::get('api/publish/buy/one/get/one/campaign','HomeController@MainOfferBanner');
    // about footer route
    ...
    Route::get('api/mobile/filtering/category/wise/product/{slug}', 'HomeController@MobileFilteringCategoryWiseProduct');
    ...
    Route::get('api/sub-categories/{slug}', 'HomeController@subCategory');
   ...
   // slider display route started here
    ...
    Route::get('api/banners', 'HomeController@Banners');
    Route::get('api/top/selling/products', 'HomeController@TopSellingProducts');
    Route::get('api/new/products', 'HomeController@NewArrivalProducts');
    Route::get('api/offer/products', 'HomeController@OfferProducts');
    Route::get('api/suggested/products', 'HomeController@SuggestProducts');
    Route::get('api/display/category/slider/{slug}', 'HomeController@CategorySlider');
    Route::get('api/display/sub/category/slider/{slug}', 'HomeController@SubCategorySlider');
    Route::get('api/display/sub/sub/category/slider/{slug}', 'HomeController@SubSubCategorySlider');
   // slider route end
    ...
    //wishlist route..........
    Route::get('api/wishlist/store/{id}', 'CartController@addWishlist');
    Route::get('api/wishlist/content', 'CartController@viewWishlist');
    Route::get('api/wishlist/item/remove/{rowId}', 'CartController@wishlistDestroy');
...
Route::group([
 ...
 Route::get('api/fond/transfer','FondTransferController@index');
   ...
   //print house route is here
    ...
    Route::get('api/cancel/showroom/return/product/{id}','ShowroomController@cancelReturnProduct');
    Route::get('api/recieve/showroom/return/product/{showroom_id}/{product_id}/{transaction_id}','ShowroomController@receiveReturnProduct');
    Route::get('api/showroom/product/return/list','ShowroomController@returnTransaction');
...
Route::get('api/city/list/for/order','Admin\CityController@cityList');
...
Route::get('login/{provider}', 'Admin\SocialAuthController@redirectToProvider');
Route::get('auth/{provider}/callback', 'Admin\SocialAuthController@handleProviderCallback');
