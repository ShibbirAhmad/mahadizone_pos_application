    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          ...
          <router-link :to="{name:'ReturnOrder'}" class="btn btn-sm btn-success active">Return</router-link>
                  ...
                  <table class="table text-center table-striped table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>
                          <button @click="toggleActions(order.id)" class=" btn btn-success btn-sm">-- <i class="fa fa-bars"></i> --</button>
                          <div class="order_action_container" :id="'order_action_container_'+order.id" style="margin-top: 2px">
                          <button
                          ...
                          <router-link class="btn btn-sm btn-warning" :to="{name:'orderEdit',params:{id:order.id}}" style="width:70px; margin-bottom: 2px">Edit</router-link>
...
export default {
  ...
  methods: {
     toggleActions(id){
        document.getElementById('order_action_container_'+id).classList.toggle('order_action_toggle');
    },
    //get order list
    ordersList(page = 1) {
      //start progress bar
