                ...
                <div class="single_p_right_section">
                    <ul>
                      ...
                      <div class="social_media_share">
                        <facebook  style="cursor:pointer" :url="'https://sufiglobal.com/'+product.slug" scale="2"></facebook>
                        <linkedin style="cursor:pointer"  :url="'https://sufiglobal.com/'+product.slug"  scale="2"></linkedin>
                        <whats-app style="cursor:pointer" :url="'https://sufiglobal.com/'+product.slug"  title="Hello" scale="2"></whats-app>
                        <pinterest style="cursor:pointer" :url="'https://sufiglobal.com/'+product.slug"  scale="2"></pinterest>
