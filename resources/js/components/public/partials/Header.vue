      ...
      <div class="container-fluid flex">
        <div class="main-header-left">
          ...
          <li>
            <form id="search_form" class="header_search_form"  @submit.prevent="subMitAutoComppleteForm">
              <vue-typer
                id="type_writer" class="auto_writer"
                :text='["Mens & Womens Fashion ",
                        "Panjabi,Pant,Shirt,T-Shirt & Winter-Clothing",
                        "Women Sharee,Two/Three Piece,Kurti",
                        "Couple Dress,Wedding Collections,Jewellry",
                        "Accessories,Home & Life Style",
                        ]'
                :repeat='Infinity'
                :shuffle='false'
        ...
        <div class="main-header-right">
         ...
         <li v-else>
           ...
           <li>
             <router-link class="merchant_login"   target="_blank" :to="{name : 'merchant_login' }" > <i class="fa fa-users"></i> Merchant</router-link>
          </li>
          <li>
           ...
           <li>
             <select name="currency" class="form-control header_currency" >
