            ...
            <div class="content_card content_card_on_slider">
              <div class="content_card_body text-center">
                ...
                <!-- <p class="price">
                  ...
                  <span v-if="item.discount > 0" class="new_product_discount">
  ...
  data() {
    return {
      ...
      content_options: {
        ...
        autoplay: { play: false, repeat: true, speed: 4000 },
      },
    };
  },
  methods: {
    //  getNewProducts(){
    //    axios.get('/_public/api/new/products')
    //    .then(resp => {
    //      console.log(resp);
    //      if (resp.data.status=='OK') {
    //        this.new_products= resp.data.new_products ;
    //      }
    //    })
    //  }
  },
