...
export default {
  ...
  methods: {
    ...
    getoutlet() {
      axios.get("/api/get/outlet").then((resp) => {
        if (resp.data.status == "OK") {
          this.form.name = resp.data.outlet.name;
          this.form.email = resp.data.outlet.email;
          this.form.phone = resp.data.outlet.phone;
          this.form.address = resp.data.outlet.address;
          this.form.image = resp.data.outlet.image;
        }
      });
    },
