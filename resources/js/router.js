...
const routes = [
    ...
    {
        path: '/',
        component: () => import(/* webpackChunkName: "welcome" */'./components/public/Index.vue'),
        name: 'welcome',
        props: true,
        meta: {
    ...
    {
        path: '/carrier',
        component: () => import(/* webpackChunkName: "publicCarreir" */'./components/public/carrier/index'),
        name: 'carrier_public',
        meta: {
            title: 'Carrier '
        }
    },
    {
        ...
        component: () => import(/* webpackChunkName: "carier_detail" */'./components/public/carrier/CarrierDetails'),
...

    {
        ...
        component: () => import(/* webpackChunkName: "public_sub_sub_category" */'./components/public/SubSubCategoryProduct.vue'),
    ...
    {
        path: '/wishlist',
        component: () => import(/* webpackChunkName: "wishlist" */'./components/public/Wishlist.vue'),
        name: 'wishlist',
    ...
    {
        path: '/new-arrival/products/:slug',
        component: () => import(/* webpackChunkName: "new_arrival_products" */'./components/public/NewArrivalProducts.vue'),
...

    {
        ...
        component: () => import(/* webpackChunkName: "offer_products" */'./components/public/OfferProducts.vue'),
        name: 'offer_products',
    ...
    {
        path: '/user/reset/password/:mobile_no',
...

    {
        ...
        component: () => import(/* webpackChunkName: "checkout_success" */'./components/public/partials/OrderWelcome.vue'),
    ...
    {
        path: '/backend/banner',
        component: () => import(/* webpackChunkName: "banner" */'./components/admin/banner/Index'),
        name: 'banner',
        meta: {
            requiresAuthAdmin: true,
            title: 'banner'
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName: "banner_add" */'./components/admin/banner/Add'),
        name: "banner_add",
        meta: {
            requiresAuthAdmin: true,
            title: 'banner || add'
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName: "banner_edit" */'./components/admin/banner/Edit'),
        name: 'banner_edit',
        meta: {
            requiresAuthAdmin: true,
            title: 'banner || edit'
...

   {
...

    {
        ...
        component: () => import(/* webpackChunkName: "passwordChange" */'./components/admin/admin/Password.vue'),
        name: 'passwordChange',
        meta: {
            requiresAuthAdmin: true
        }
